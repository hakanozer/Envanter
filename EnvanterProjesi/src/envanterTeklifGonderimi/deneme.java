...
import static envanterteklif.TeklifGonderimi.teklifID;
...
public void datagetir(){
    try {
            DB db = new DB();
            ResultSet rs = db.baglan().executeQuery("select tekliflistesi_aciklama from tekliflistesi");
            while (rs.next()) {
                metaphaseEditor1.setDocument(rs.getString("tekliflistesi_aciklama"));
            }
